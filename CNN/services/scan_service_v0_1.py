...
async def _openai_scan_final(
    ...
    *,
    ...
    developer_msg = (
        ...
        "the provided schema. No extra text. Keep it short and precise, return will fail if exceeds 8 secs.\n\n"
        "Rules:\n"
        "1) Do NOT ask the user questions. Do NOT output any quiz or follow-up questions.\n"
        "2) category:\n"
